# rank1 class copied from https://github.com/orionw/rank1/blob/main/rank1.py
# Adding the routir wrapper at the end
import logging
import math
import os
...
class Rank1Engine(Engine):
    ...
    async def score_batch(self, queries, passages, candidate_length = None, **kwargs):
        # return await super().score_batch(queries, passages, candidate_length, **kwargs)
